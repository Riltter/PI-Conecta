        ...
        <>
            ...
            <section>
                <div className={style.div_apresentacao}>
                    <img className={style.imagem_apresentacao} src=".\public\assets\azul.jpg" alt="Pessoas com roupa azul!" />
                ...
                <div className={style.div_apresentacao2}>
                    ...
                    <img className={style.imagem_apresentacao} src="./public/assets/maos.jpg" alt="Maos juntas" />
                </div>
                <div className={style.div_apresentacao}>
                    <img className={style.imagem_apresentacao} src=".\public\assets\pessoas.jpg" alt="Pessoas trabalhando" />
